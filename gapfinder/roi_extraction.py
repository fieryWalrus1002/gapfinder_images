...
def extract_rois(roi_metadata_csv: str, output_roi_metadata: str, rotated_images_folder: str, output_folder: str):
    # Load the ROI metadata
    roi_metadata = pd.read_csv(roi_metadata_csv)
    ...
    new_roi_metadata.to_csv(output_roi_metadata, index=False)

    print(f"Processing completed. New ROI metadata saved to '{output_roi_metadata}'")
