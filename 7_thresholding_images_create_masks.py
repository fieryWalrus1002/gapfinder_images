...
if __name__ == "__main__":
    ...
    opts_equalize = [True] # whether to equalize the image before thresholding
    opts_blur = [True] # whether to blur the image before thresholding
